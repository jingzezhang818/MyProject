...
namespace ORB_SLAM3 {
    ...
    void EdgeSE3ProjectXYZ::linearizeOplus() {
        ...
        // Avoid dangling Eigen expression references under ASan:
        // force materialization instead of storing a lazy expression in `auto`.
        const Eigen::Matrix<double,2,3> projectJac = (-pCamera->projectJac(xyz_trans)).eval();
